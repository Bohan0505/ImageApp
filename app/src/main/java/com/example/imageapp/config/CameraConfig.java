package com.example.imageapp.config;
...
import com.example.imageapp.util.CameraUtil;
...
public class CameraConfig {
    ...
    public void initFromCameraParameters(Camera camera) {
        ...
        mScreenResolution = CameraUtil.getScreenResolution(mContext);
        Point screenResolutionForCamera = new Point();
        screenResolutionForCamera.x = mScreenResolution.x;
        screenResolutionForCamera.y = mScreenResolution.y;

        // preview size is always something like 480*320, other 320*480
        int orientation = CameraUtil.getOrientation(mContext);

        if (orientation == CameraUtil.ORIENTATION_PORTRAIT) {
